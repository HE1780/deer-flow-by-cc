...
export const enUS: Translations = {
  ...
  admin: {
    ...
    pages: {
      ...
      usersTitle: "Users",
      rolesTitle: "Roles",
      rolesScopePlatform: "Platform",
      rolesScopeTenant: "Tenant",
      rolesScopeWorkspace: "Workspace",
      rolesBuiltinTag: "builtin",
    ...
    forms: {
      slugLabel: "Slug",
      slugHint: "2–64 chars, lowercase letters, digits, or dashes.",
      displayNameLabel: "Display name",
      emailLabel: "Email",
      tenantCreateTitle: "New tenant",
      tenantCreateDesc: "Platform admins can create a new tenant. The slug is permanent — choose carefully.",
      tenantRenameTitle: "Rename tenant",
      tenantRenameDesc: "The display name can be changed freely; the slug is permanent.",
      workspaceCreateTitle: "New workspace",
      workspaceCreateDesc: "The slug is scoped to the current tenant and permanent.",
      workspaceRenameTitle: "Rename workspace",
      workspaceRenameDesc: "The display name can be changed freely; the slug is permanent.",
    },
    audit: {
      filterAction: "Action (e.g. user.login.success)",
      ...
      detailTenantId: "Tenant id",
      detailWorkspaceId: "Workspace id",
    ...
    tokens: {
      ...
      createDesc: "The plaintext is shown once. Copy it now — we never store it in recoverable form.",
      nameLabel: "Name",
      scopesLabel: "Scopes (comma-separated)",
      createdTitle: "Token created",
      createdDesc: "Copy this value now — once you close this dialog, only the prefix remains.",
    },
    tenantSwitcher: {
      label: "Tenant",
    },
