...
export const zhCN: Translations = {
  ...
  admin: {
    ...
    forms: {
      slugLabel: "标识符",
      slugHint: "2–64 个字符，仅限小写字母、数字或连字符。",
      displayNameLabel: "显示名称",
      emailLabel: "邮箱",
      tenantCreateTitle: "新建租户",
      tenantCreateDesc: "平台管理员可创建新租户。标识符一经确认不可更改，请谨慎填写。",
      tenantRenameTitle: "重命名租户",
      tenantRenameDesc: "显示名称可随时修改，标识符不可更改。",
      workspaceCreateTitle: "新建工作区",
      workspaceCreateDesc: "标识符在当前租户内唯一且不可更改。",
      workspaceRenameTitle: "重命名工作区",
      workspaceRenameDesc: "显示名称可随时修改，标识符不可更改。",
    },
    audit: {
      filterAction: "操作（例如 user.login.success）",
      filterUserId: "用户 ID",
      filterResource: "资源类型",
      filterResult: "结果",
      resultAll: "全部",
      ...
      detailResult: "结果",
      detailUserId: "用户 ID",
      detailTenantId: "租户 ID",
      detailWorkspaceId: "工作区 ID",
      detailThreadId: "会话 ID",
      detailResourceType: "资源类型",
      detailResourceId: "资源 ID",
      detailIp: "IP",
      detailUserAgent: "用户代理",
      detailDuration: "耗时",
      detailErrorCode: "错误码",
      detailMetadata: "元数据",
      close: "关闭",
    ...
    tokens: {
      ...
      createDesc: "明文仅显示一次，请立即复制——我们不会以可恢复的形式存储它。",
      nameLabel: "名称",
      scopesLabel: "权限范围（逗号分隔）",
      createdTitle: "令牌已创建",
      createdDesc: "请立即复制此值——关闭对话框后仅保留前缀。",
    },
    tenantSwitcher: {
      label: "租户",
    },
